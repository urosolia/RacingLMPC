...
def main():
    ...
    # animation_states(map, LMPCOpenLoopData, LMPController, Laps-2)
    # animation_states(map, LMPCOpenLoopData, LMPController, Laps-2)
    # animation_states(map, LMPCOpenLoopData, LMPController, Laps-2)
    # animation_states(map, LMPCOpenLoopData, LMPController, Laps-2)
...
def initLMPCparameters(map, N):
   ...
   # Safe Set Parameters
    ...
    # Tuning Parameters
    QterminalSlack  = 5*20 * np.diag([10, 1, 1, 10, 10, 1])    # Cost on the slack variable for the terminal constraint
